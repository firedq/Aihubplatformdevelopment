...
import { Send, Sparkles, Eye, Save, ArrowLeft, Layers } from 'lucide-react';
...
export function FormEditor({ 
  ...
  const [currentFormConfig, setCurrentFormConfig] = useState<any>(initialConfig || null);
